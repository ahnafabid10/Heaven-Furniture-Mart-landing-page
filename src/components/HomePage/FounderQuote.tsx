...
export function FounderQuote() {
  return (
    <section className="w-full bg-[#111A1F] py-24 sm:py-28 lg:py-36 relative overflow-hidden border-b border-[#2B1E16]/20">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-[#C5A25D]/5 rounded-lg blur-3xl pointer-events-none" />

      <div className="w-full max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 text-center">
        
        {/* Top Gold Quotation Mark */}
        <div className="text-3xl sm:text-4xl text-[#C5A25D] font-serif mb-6 select-none opacity-85">
          ❝
        </div>
        ...
        <div className="space-y-1">
          <h3 className="text-white text-base sm:text-lg tracking-wide">
            Abul Kalam Bhuiyan
          </h3>
