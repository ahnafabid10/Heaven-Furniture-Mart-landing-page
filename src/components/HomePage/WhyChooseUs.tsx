  ...
  return (
    <section className="w-full bg-[#FAF8F5] py-16 sm:py-20 lg:py-24 border-b border-[#2B1E16]/10" id="why-choose-us">
      <div className="w-full max-w-[1560px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        {/* Eyebrow Pill Tag */}
        <div className="inline-flex items-center px-4 py-1.5 rounded-full border border-[#2B1E16]/20 bg-white/60 mb-4 shadow-sm">
          <span className="text-xs font-bold uppercase tracking-[0.18em] text-[#2B1E16]/75">
            WHY CHOOSE US
          </span>
        </div>

        {/* Section Headline */}
        <h2 className="font-serif text-3xl sm:text-4xl lg:text-[46px] font-bold text-[#132026] tracking-tight leading-[1.18] mb-10 sm:mb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-stretch">
          ...
          <div className="lg:col-span-8 flex flex-col gap-5 sm:gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 flex-1">
              ...
              <div className="rounded-[28px] p-7 sm:p-8 bg-[#F3F4F6]/75 border border-[#2B1E16]/10 hover:border-[#C5A25D]/50 hover:bg-white transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-md">
                <div>
                  {/* Icon Badge */}
                  <div className="w-12 h-12 rounded-full border border-[#2B1E16]/20 bg-white flex items-center justify-center text-[#132026] mb-6 shadow-xs">
                  ...
                  <h3 className="font-serif text-xl sm:text-2xl font-bold text-[#132026] mb-3 leading-snug">
            ...
            <div className="rounded-[28px] p-7 sm:p-8 bg-[#F3F4F6]/75 border border-[#2B1E16]/10 hover:border-[#C5A25D]/50 hover:bg-white transition-all duration-300 shadow-sm hover:shadow-md">
              <div>
                {/* Icon Badge */}
                <div className="w-12 h-12 rounded-full border border-[#2B1E16]/20 bg-white flex items-center justify-center text-[#132026] mb-6 shadow-xs">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-4 rounded-[28px] p-8 sm:p-9 bg-[#132026] text-white flex flex-col justify-between shadow-xl relative overflow-hidden border border-[#132026]">
            
            {/* Subtle luxury glow background */}
            <div className="absolute -top-24 -right-24 w-60 h-60 bg-[#C5A25D]/15 rounded-full blur-3xl pointer-events-none" />

            <div className="relative z-10">
              {/* Circular Icon */}
              <div className="w-12 h-12 rounded-full border border-white/20 bg-white/10 backdrop-blur-md flex items-center justify-center text-[#C5A25D] mb-7 shadow-xs">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
              ...
              {/* Title */}
              <h3 className="font-serif text-2xl sm:text-[28px] font-bold text-white mb-4 leading-snug">
            ...
            <div className="relative z-10 pt-8 mt-auto">
              <Link
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#25D366] hover:bg-[#20be5b] text-[#132026] font-bold text-sm tracking-wide transition-all duration-200 shadow-md hover:shadow-lg hover:scale-[1.02]"
              >
